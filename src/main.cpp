...
int main(int argc, char *argv[])
{
    ...
    TabController tab_controller{app_state, code_tab, file_tab, function_tab, string_tab, multi_trace_tab, single_trace_tab};

    app_state->screen.SetCursor(ftxui::Screen::Cursor(0, 0, ftxui::Screen::Cursor::Hidden));
    if (!app_state->binary_path.empty()) code_tab->update_code();
